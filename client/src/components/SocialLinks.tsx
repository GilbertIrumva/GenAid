...
export default function SocialLinks({ className = "", itemClassName = "" }: { className?: string; itemClassName?: string }) {
  const linkStyle = itemClassName || "text-neutral-body dark:text-slate-300 transition hover:text-brand-600 dark:hover:text-brand-400";
  return (
